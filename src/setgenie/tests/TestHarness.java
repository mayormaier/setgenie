...
import setgenie.User;
import setgenie.Workout;
import setgenie.WorkoutElement;
import setgenie.WorkoutSet;
...
public class TestHarness {
    ...
    public void testUserClass() {
        ...
        User u1 = new User("Bob", "Jones", "bjones@email.com" , "bobstrongpassword", "bjones1", User.ROLE.ATHLETE);
    ...
    public void testWorkoutClass() {
        ...
        // Creating User
        User u1 = new User("Bob", "Jones", "bjones@email.com" , "bobstrongpassword", "bjones1", User.ROLE.ATHLETE);
        User u2 = new User("Billy", "Johns", "bjohns@email.com" , "billystrongpassword", "bjohns1", User.ROLE.COACH);
